...
public class Client implements Serializable{
      ...
      int idade = 0, numDepend = 0, tempoServ = 0;
            ...
            try{
                  Lista l = (Lista) Naming.lookup("rmi://127.0.0.1:1099/ListaService");
                  ...
                  String teste = numberMappingQ1.get("Nome");
                  System.out.println("Teste de impressao da variavel nome do HashMap : " +teste);//Imprime variáveis separadas
                  
                  System.out.println(numberMappingQ1); //Imprime toda a Hashtable completa (Map Collection).
